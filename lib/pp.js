(function() {
  ...
  pp.extend(function(util) {
    var TIME_SLICE, getUnixTime, invoke, limitTimeSlice;
    TIME_SLICE = (function() {
    ...
    invoke = function(proc, timeSlice) {
      var timeLimit;
      ...
      trampoline: function(fn) {
        ...
        return partialized = function() {
          ...
          if (requireLength <= args.length) {
            ...
            timeSlice = limitTimeSlice(requireLength < args.length ? args[requireLength] : null);
            pp.defer(invoke, proc, timeSlice);
            return;
          }
  ...
  pp.extend(function(util) {
    return util.trampolines({
      any: function(iterator, receiver, iterable) {
        var after, pred;
        pred = function(next, value, key, iterable) {
          var afterCheck;
        ...
        return util.each(pred, after, iterable);
      },
